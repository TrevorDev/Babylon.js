    ...
    export namespace _Labs {
        ...
        export class XRManger {
            ...
            exitXR():Promise<void>{
                ...
                // TODO: this needed to be set as its the only way to trigger reset in restoreDefaultFramebuffer
            ...
            enterXR(requestSessionOptions:any):Promise<void>{
                ...
                .then((session:any)=>{
                   ...
                   // this.scene.getEngine().getRenderingCanvas()!.style.cssText = "visibility:hidden"
                    ...
                    // TODO: I think somehow bindFramebuffer should be used instead of camera _outputBuffer
                    // var intText = new InternalTexture(this.scene.getEngine(), InternalTexture.DATASOURCE_UNKNOWN, this._xrSession.baseLayer.framebuffer);
