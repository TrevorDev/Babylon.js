    ...
    export class Engine {
        ...
        public _renderLoop(time:any, frame?:any): void {
            if (!this._contextWasLost) {
                ...
                if (shouldRender) {
                    // TODO this is the same as onBeginFrameOBservable but these parameters are needed and I cant change for back compat
                    // Another option would be to store these in the engine and they could be queried by callback
