           ...
           if (!this._dragMesh) 
            ...
            if (pickResult && pickResult.hit) {
                if (pickResult.pickedMesh === this._attachedNode) {
                    ...
                    {
                        case DragPlaneMode.X:
                            this._dragPlaneMode = DragPlaneMode.XY
                        case DragPlaneMode.Y:
                            this._dragPlaneMode = DragPlaneMode.YZ
                        case DragPlaneMode.Z:
                            this._dragPlaneMode = DragPlaneMode.XZ
